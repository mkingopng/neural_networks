...
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{img_2}
...
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{img_3}

\section{Cerebral Cortex}\label{sec:cerebral-cortex}
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{img_4}

\section{Brain Functions}\label{sec:brain-functions}
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{img_5}
